...
def handle_message(event):
    ...
    if event.message.text == '這隻狗叫什麼名字':    
    ...
    elif event.message.text == '所有狗狗介紹':
        with open('all_dogs_0525.json',encoding='utf-8') as d:      ### all_dogs_0525.json ###
            test = json.load(d)
        line_bot_api.reply_message(
        event.reply_token,FlexSendMessage('有哪些狗',test)
        )

    elif event.message.text == '小黑小檔案':                       
        imglink = "https://imgur.com/lShVKyv.jpg"                   ### 小檔案照片link ###
        ...
        imglink = "https://imgur.com/gwc0DYC.png"
    ...
    elif event.message.text == '我想領養':
        with open('adopt.json',encoding='utf-8') as d:          ### adopt.json ####
            test = json.load(d)
        line_bot_api.reply_message(
        ...
        with open('all_members.json',encoding='utf-8') as d:       ### all_members.json ####
            test = json.load(d)
        line_bot_api.reply_message(
        event.reply_token,FlexSendMessage('開發團隊',test)
        )
